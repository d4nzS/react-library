...
const USER_FULL_DATA = {
    ...
    comments: [{
        id: 189, rating: 3, text: 'test text comment', bookId: 94,
    },],
    avatar: '/uploads/294928_original_748468a52a.jpg',
    booking: {
        id: 185, order: true, dateOrder: '2023-03-30T00:00:00.000Z', book: {
            id: 25, title: 'Жажда', issueYear: '2018', authors: ['Игорь Рыбаков'], image: null,
        },
    },
    delivery: {
        id: 460,
...
const USER_NO_BOOKING = {
    ...
    comments: [{
        id: 23, rating: 4, text: 'Читабельно', bookId: 71,
    }, {
        id: 24, rating: 3, text: 'дядя Алех', bookId: 38,
    }, {
        id: 27, rating: 3, text: 'Отзыв', bookId: 94,
    },],
    avatar: '/uploads/cypress_a55ead3e6e.jpg',
    booking: {
        id: null, order: null, dateOrder: null, book: null,
    },
    delivery: {
        id: 460,
        handed: true,
...
const USER_NO_DELIVERY = {
    ...
    avatar: '/uploads/cypress_a55ead3e6e.jpg',
    booking: {
        id: 185, order: true, dateOrder: '2023-03-13T00:00:00.000Z', book: {
            id: 25, title: 'Жажда', issueYear: '2018', authors: ['Игорь Рыбаков'], image: null,
        },
    },
    delivery: {
...
const USER_EXPIRED_HANDED = {
    ...
    avatar: '/uploads/cypress_a55ead3e6e.jpg',
    booking: {
        id: 185, order: true, dateOrder: '2023-12-13T00:00:00.000Z', book: {
            id: 25, title: 'Жажда', issueYear: '2018', authors: ['Игорь Рыбаков'], image: null,
        },
    },
    delivery: {
...
const BOOKS = [{
    ...
    issueYear: '2018', rating: 3, title: 'Мастер времени', authors: ['Брайан Трейси'], image: {
        url: '/uploads/10689720_0_Master_vremeni_Brayan_Treysi_e841bace3e.jpg',
    }, categories: ['Бизнес'], id: 7, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2019',
    rating: null,
    ...
    issueYear: '2018', rating: null, title: 'Жажда', authors: ['Игорь Рыбаков'], image: {
        url: '/uploads/Igor_Rybakov_Zhazhda_03e6027493.jpeg',
    }, categories: ['Бизнес'], id: 25, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2019',
    rating: 3.5,
    ...
    issueYear: '2014', rating: 3, title: 'Клиенты на всю жизнь', authors: ['Карл Сьюэлл'], image: {
        url: '/uploads/1017697_0_Klienti_na_vsyu_zhizn_Karl_Syuell_Pol_Braun_b1e187d02c.jpg',
    }, categories: ['Бизнес'], id: 27, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2019',
    rating: null,
    ...
    issueYear: '2020', rating: null, title: 'Спроси маму', authors: ['Роб Фитцпатрик'], image: {
        url: '/uploads/10968986_0_34ca8465ed.jpg',
    }, categories: ['Бизнес'], id: 41, booking: null, delivery: null, histories: [{
        id: 3, userId: 1,
    },],
}, {
    issueYear: '2019',
    ...
    issueYear: '2019', rating: null, title: 'Додо Книга', authors: ['Максим Котин'], image: {
        url: '/uploads/Dodo_kniga_702e2a4239.jpeg',
    }, categories: ['Бизнес'], id: 49, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2020',
    rating: null,
    ...
    issueYear: '2015', rating: null, title: 'Суперпамять', authors: ['Тони Бьюзен'], image: {
        url: '/uploads/1014568_0_4744f1508e.jpg',
    }, categories: ['Бизнес'], id: 51, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2019',
    rating: null,
    title: '15 секретов управления временем. Как успешные люди успевают всё',
    ...
    issueYear: '2018', rating: null, title: 'Принципы', authors: ['Рэй Далио'], image: {
        url: '/uploads/6020019394_43b89b7ee9.webp',
    }, categories: ['Бизнес'], id: 56, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2018',
    rating: null,
    ...
    issueYear: '2020', rating: null, title: 'Карьера менеджера', authors: ['Ли Якокка'], image: {
        url: '/uploads/1009079162_8a69bcb3f9.webp',
    }, categories: ['Бизнес'], id: 61, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2021',
    rating: null,
    ...
    issueYear: '2020', rating: 3.86, title: 'Хочу и буду', authors: ['Михаил Лабковский'], image: {
        url: '/uploads/10582784_0_6ba1f42ade.jpg',
    }, categories: ['Психология'], id: 69, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2018',
    rating: null,
    ...
    issueYear: '2018', rating: null, title: 'Чертоги разума', authors: ['Андрей Курпатов'], image: {
        url: '/uploads/10718454_0_eba76b8c65.jpg',
    }, categories: ['Психология'], id: 80, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2020',
    rating: null,
    ...
    issueYear: '2019', rating: 2, title: 'Школа дизайна. Шрифт', authors: ['Ричард Пулин'], image: {
        url: '/uploads/10907435_0_3937c2d1d6.jpg',
    }, categories: ['Дизайн'], id: 133, booking: null, delivery: null, histories: null,
}, {
    issueYear: '2019',
    rating: 2.33,
...
describe('Sprint 2', () => {
    ...
    const BOOK_MORETWO_IMAGE = {
        ...
        categories: ['Бизнес'],
        comments: [{
            id: 842, rating: 5, text: 'Тест', createdAt: '2023-03-18T16:06:31.615Z', user: {
                commentUserId: 960, firstName: 'Докторская', lastName: 'Колбаса', avatarUrl: null,
            },
        }, {
            id: 843, rating: 5, text: 'Тест[копия]', createdAt: '2023-03-18T16:07:20.646Z', user: {
                commentUserId: 959, firstName: 'Имя', lastName: 'Фамилия', avatarUrl: null,
            },
        }, {
            id: 844, rating: 3, text: '', createdAt: '2023-03-18T16:10:31.608Z', user: {
                commentUserId: 974, firstName: 'Vit', lastName: 'Vit7', avatarUrl: null,
            },
        }, {
            id: 858, rating: 3, text: '1212', createdAt: '2023-03-18T16:58:04.568Z', user: {
                commentUserId: 995, firstName: 'Toster123', lastName: 'Toster123', avatarUrl: null,
            },
        },],
        booking: null,
        delivery: null,
    ...
    describe('search and sort', () => {
        ...
        describe('bread crumbs', () => {
            describe('desktop', () => {
                beforeEach(() => {
                    getFullData();
                    cy.intercept('/api/books/127', BOOKS.find(book => book.id === 127)).as('bookId127');
                    cy.intercept('/api/books/92', BOOKS.find(book => book.id === 92)).as('bookId92');
                    cy.visit('http://localhost:3000');
                    cy.wait(['@categories', '@books', '@me']);
                    cy.viewport(1440, 900);
                });
    ...
    describe('authorization and registartion', () => {
            ...
            it('success authorization', () => {
                ...
                cy.wait('@authorize').should(({ request, response }) => {
                    ...
                    assert.deepEqual(request.body, {
                        identifier: 'Wally123', password: 'GarrusWally123',
                    });
                });
        ...
        describe('registration', () => {
            ...
            it('already used error registartion', () => {
                ...
                cy.get('[data-test-id=status-block]:contains("Такой логин или e-mail уже записан в системе. Попробуйте зарегистрироваться по другому логину или e-mail")',).should('be.visible');
                cy.contains('назад к регистрации', { matchCase: false }).click();
                cy.url().should('contain', '/registration');
            });
            it('error registartion', () => {
                cy.intercept('/api/auth/local/register', {
                    delay: 1000, statusCode: 500, body: {
                        data: null, error: {
                            status: 500, name: 'ApplicationError', message: 'error', details: {},
                        },
                    },
                }).as('failedRegistration');
                cy.url().should('contain', '/auth');
                ...
                cy.get('[data-test-id=loader]').should('be.exist');
                cy.wait('@failedRegistration');
                cy.get('[data-test-id=status-block]:contains("Что-то пошло не так и ваша регистрация не завершилась. Попробуйте ещё раз")',).should('be.visible');
            ...
            it('validation third step', () => {
                ...
                cy.get('[data-test-id=hint]:contains("В формате +375 (xx) xxx-xx-xx")').should('have.css', 'color', 'rgb(167, 167, 167)',);
...
describe('Sprint 6', () => {
    ...
    const CATEGORIES = [{
        name: 'Зарубежная литература', path: 'business', id: 1,
    }, {
        name: 'Компьютерная литература', path: 'business2', id: 2,
    },];
    ...
    const BOOK_INFO_ITEM = {
        ...
        comments: [{
            ...
            user: {
                commentUserId: 6, firstName: 'Агент', lastName: 'Смит', avatarUrl: null,
            },
        },],
        booking: {
            id: 7,
    ...
    const BOOK_INFO_PAGES = [{ ...BOOK_INFO_ITEM, booking: null }, {
        ...BOOK_INFO_ITEM, id: 2, title: 'Книга 2'
    }, { ...BOOK_INFO_ITEM, id: 3, title: 'Книга 3', booking: myBooking, delivery: null }, {
        ...BOOK_INFO_ITEM, id: 4, title: 'Книга 4', booking: null, delivery: {
            id: 7,
            handed: true,
    ...
    const BOOKS_LIST_BASE = [{ ...BASE_BOOKS_ITEM, booking: null }, {
        ...BASE_BOOKS_ITEM, id: 2, title: 'Книга 2'
    }, {
        ...BASE_BOOKS_ITEM, id: 3, booking: myBooking, delivery: null, title: 'Книга 3',
    }, {
        ...BASE_BOOKS_ITEM, id: 4, title: 'Книга 4', booking: null, delivery: {
            id: 7,
            handed: true,
            dateHandedFrom: '2023-01-24T00:00:00.000Z',
            dateHandedTo: '2023-01-28T00:00:00.000Z',
    ...
    const BOOKS_LIST_AFTER_BOOKING = BOOKS_LIST_BASE.map((item, ind) => ind === 0 ? {
        ...BOOKS_LIST_BASE[0], booking: myBooking
    } : item,);

    const BOOKS_LIST_AFTER_EDIT_BOOKING = BOOKS_LIST_BASE.map((item, ind) => ind === 2 ? {
        ...BOOKS_LIST_BASE[2], booking: { ...myBooking, dateOrder: '2023-01-20T00:00:00.000Z' },
    } : item,);

    const BOOKS_LIST_AFTER_DELETE_BOOKING = BOOKS_LIST_BASE.map((item, ind) => ind === 2 ? {
        ...BOOKS_LIST_BASE[2], booking: null,
    } : item,);

    const BOOK_INFO_PAGE_AFTER_COMMENT = {
        ...BOOK_INFO_ITEM, booking: null, rating: 3, comments: [...BOOK_INFO_ITEM.comments, {
            id: 2, rating: 4, text: myCommentText, createdAt: '2023-01-19T00:00:00.000Z', user: {
                commentUserId: myId, firstName: myName, lastName: myLastName, avatarUrl: null,
            },
        },],
    };
    ...
    const BOOKING_RESPONSE = {
        id: 5, attributes: {
            order: true, dateOrder: '2023-01-19T00:00:00.000Z', book: '1', customer: myId,
        },
    };
    ...
    const checkBookingButton = (bookId, isDisabled = false, btnText = '', colorText = 'rgb(255, 255, 255)',) => {
        cy.intercept(`https://strapi.cleverland.by/api/books/${bookId}`, {
            body: BOOK_INFO_PAGES[bookId - 1], statusCode: 200,
        }).as(`book${bookId}`);
    ...
    const openBookingModal = (isEdit = false) => cy
    ...
    const clickDay = (dayNum, isForce) => cy
        ...
        describe('books rating', () => {
            ...
            it('check rate modal elements', () => {
                cy.intercept(`https://strapi.cleverland.by/api/books/1`, {
                    body: BOOK_INFO_PAGES[0], statusCode: 200,
                }).as(`book1`);
                cy.visit('http://localhost:3000/#/books/all');
                cy.wait(['@me', '@categories', '@books']);
...
describe('Sprint 7', () => {
    ...
    describe('Profile functions tests', () => {
        ...
        const formTest = (width, heigth) => {
            ...
            cy.get('[data-test-id=profile-form] input[name=phone]').should('have.value', '');
